let phrases = [
    { text: 'отправить Роме и Уле смешную гифку', image: 'https://code.s3.yandex.net/web-code/procrastinate/1.gif' },
    ...
    { text: 'посмотреть в книгу по CSS и JS и ничего не понять', image: 'https://code.s3.yandex.net/web-code/procrastinate/5.png' },
